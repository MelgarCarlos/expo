...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Primero",sLast:"Ultimo",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"Datos no disponibles en tabla",sInfo:"Mostrando _START_ de _END_ de _TOTAL_ Resultados",sInfoEmpty:"Mostrando 0 de 0 de 0 resultados",sInfoFiltered:"(Filtrando de _MAX_ total resultados)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ resultados",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Búsqueda:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
