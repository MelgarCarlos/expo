...
<body style="background-color: #fffff9;">    
	...
	{ 
		...
		$consulta="INSERT INTO promociones VALUES(".$id.",'".$ti."','".$des."','".$fichero_subido."','".$fecha."')";
    ...
    <table style="width: 60%;margin: 0px;padding: 0px;">
        <tr>
            <td style="width: 50%;padding-top:5px;">
                <a href="promocionesagregar.php">
                <h5 class="align-center fg-blue" style="text-decoration: underline;padding-top: 10px;border-style: solid;border-width: 2px 1px 0px 1px;border-color: #990000;">Agregar promocion</h5>
                </a>
            </td>
            <td>&nbsp;&nbsp;</td>
            <td style="width: 50%;padding-top:5px;">
                <a href="promocionesmanto.php">
        ...
        <center>
            <h4 class="bg-teal fg-white padding10" style="margin-bottom: 0px;text-shadow: 0px 0px 4px rgba(150, 150, 150, 1);"><span style="padding-bottom: 5px;" class="mif-dollars" ></span> Agregar promocion</h4>
        </center>
        </div>
    <form action="promocionesagregar.php" method="post" data-role="validator" data-show-required-state="false" data-hint-mode="line" data-hint-background="bg-red" data-hint-color="fg-white" data-hide-error="5000" enctype="multipart/form-data">
            <div style="padding: 1% 30% 1% 30%;">
                <label> Id</label>
                <br>
                <div style="width: 100%;" class="input-control text" data-role="input" >
                    <input name="id_txt"  autocomplete="off"  maxlength="11" type="text" data-validate-func="pattern" data-validate-arg="^[0-9]+$" placeholder="Id" data-validate-hint="Llene el id del servicio(solo numeros)">
        ...
        <div style="padding: 1% 30% 1% 30%;">
                ...
                <br>
                <div style="width: 100%;" class="input-control text" data-role="input" >
                    <input name="titulo_txt"  autocomplete="off"  maxlength="40" type="text" data-validate-func="pattern" data-validate-arg="^([a-zA-Z ])+$" placeholder="Titulo" data-validate-hint="Llene el campo del tipo(solo letras)">
                    <span class="input-state-error mif-warning"></span>
                    <span class="input-state-success mif-checkmark"></span>
                </div>
            </div>
        ...
        <div style="padding: 1% 30% 1% 30%;">
                ...
                <div class="input-control text" style="width: 100%;" data-role="datepicker">
                    <input name="fecha_txt" type="text" data-validate-func="required" placeholder="Fecha" data-validate-hint="Llene la fecha">
