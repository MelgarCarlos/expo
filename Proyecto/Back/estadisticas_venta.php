    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        <?php 
                            ...
                            $sql="select count(*),productos.nombre from detalle_pedido,productos where detalle_pedido.producto=productos.id GROUP by producto limit 5";
        ...
        data.addRows([
                            ...
                            <?php }} ?>
                                    // Set chart options
        var options = {'title':'Productos mas vendidos(Historicamente)',
                       'width':800,
                       'height':300};
