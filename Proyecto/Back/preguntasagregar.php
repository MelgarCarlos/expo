    ...
    <form action="preguntasagregar.php" method="post" data-role="validator" data-show-required-state="false" data-hint-mode="line" data-hint-background="bg-red" data-hint-color="fg-white" data-hide-error="5000">
            <div style="padding: 1% 30% 1% 30%;">
                ...
                <div style="width: 100%;" class="input-control text" data-role="input" >
                    <input name="id_txt" maxlength="11" autocomplete="off"  type="text" data-validate-func="pattern" data-validate-arg="^[0-9]+$" placeholder="Id" data-validate-hint="Llene el id de pregunta(solo numeros)">
            ...
            <div style="padding: 1% 30% 1% 30%;">
                ...
                <br>
                <div style="width: 100%;" class="input-control text" data-role="input" >
                    <input name="pregunta_txt" autocomplete="off"   maxlength="100" type="text" data-validate-func="pattern" data-validate-arg="^([a-zA-Z ñ])+$" placeholder="Pregunta" data-validate-hint="Llene el campo de pregunta(solo letras)">
                    <span class="input-state-error mif-warning"></span>
                    <span class="input-state-success mif-checkmark"></span>
                </div>
            </div> 
